...
/**
 * Profile Screen
 * View and edit user profile, view sync status, logout
 */
export default function ProfileScreen() {
  ...
  // Photo queue stats from draft store
  ...
  // Calculate local storage on mount
  useEffect(() => {
    try {
      ...
      >
        ...
        >
          <View style={styles.sectionHeader}>
            ...
            <Pressable
              onPress={() => router.push('/(surveyor)/profile/edit')}
              style={({ pressed }) => [
              ...
              <View style={styles.profileInfo}>
                ...
                <View style={[styles.roleBadge, { backgroundColor: `${colors.primary[500]}15` }]}>
                  <Text style={[styles.roleText, { color: colors.primary[600] }]}>
                    {user?.role ? USER_ROLE_LABELS[user.role] : 'סוקר'}
                  </Text>
                </View>
              </View>
            </Pressable>
